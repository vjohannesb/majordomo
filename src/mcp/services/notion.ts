...
export async function createNotionPage(
  ...
  // If no parent specified, we need a database or page to create under
  // For now, require parentId
  if (!parentId) {
  ...
  let page;
  try {
    // Try creating as database item first
...
export async function queryNotionDatabase(
  ...
  // Query database using the correct API method
